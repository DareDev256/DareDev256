...
Passion Agent (24/7 Mac Mini) ─── 92 modules, 109K LOC
  ...
  └── Memory System ─── somatic markers, narrative identity
        ▼
  PACT Dashboard ─── System Matrix · Intel/Ops panels · Threat Level · Session Clock · Auto-Select toggle (useAutoSelect hook) · tier-visual feedback · MomentumGauge · useSSE streaming · 121 components, 695 tests
        ▼
